...
if (isset($_POST['submit'])) {
    ...
    error_log("Customer Name: " . $customer_name); // Log the customer name

    // Insert sales data into the 'sales' table
    $query = "INSERT INTO sales (invoice_date, invoice_number, cname, total_cost, amt_paid, balance) VALUES (?, ?, ?, ?, ?, ?)";
    if ($stmt = mysqli_prepare($con, $query)) {
        mysqli_stmt_bind_param($stmt, 'ssdddd', $invoice_date, $invoice_number, $customer_name, $total_cost, $amt_paid, $balance);
